	...
	<div class="app-shell">
		<div class="app-layout">
					...
					<div class="explore-view" data-testid="explore-view">
						<section class="pn-card explore-hero" aria-labelledby="explore-title">
							...
							<div class="explore-hero__copy">
								...
								<p>
									Find local topics, neighboring communities, and the threads carrying across the
									federated timeline without leaving the calm shell.
								</p>
							</div>
			...
			<aside class="right-rail" data-testid="right-rail">
				{#if activeView === 'explore'}
					<div class="pn-card rail-card explore-rail-search">
						<div class="pn-card__head">
							<span class="pn-label">Discover</span>
					...
					<div class="pn-card rail-card">
						...
						<div class="shortcut-list">
							<button class="shortcut" type="button">
								...
								<span>Search focused tag</span>
								<span class="shortcut-key">/</span>
							</button>
							<button class="shortcut" type="button">
								<span class="shortcut-dot" aria-hidden="true"></span>
								<span>Open featured community</span>
								<span class="shortcut-key">J</span>
							</button>
							<button class="shortcut" type="button">
								<span class="shortcut-dot" aria-hidden="true"></span>
								<span>Cycle discover feed</span>
					...
					<div class="pn-card rail-card">
						<div class="pn-card__head">
							...
							<span class="pn-pill">Expanded</span>
						</div>
				...
				{:else if isTimelineView(activeView) || activeView === 'thread'}
