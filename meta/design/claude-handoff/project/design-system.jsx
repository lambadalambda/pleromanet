      ...
      <div className="ds-body">
        ...
        <main className="ds-main">
          ...
          <Slab id="posts" kicker="08" title="Posts" sub="The canonical post composes Avatar + PostHead + body + PostMedia + PostActions. Every post-shaped surface uses the same atoms.">
            ...
            <p className="ds-sub" style={{marginBottom: 14}}>The <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>{'<PostBody/>'}</code> primitive auto-parses <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>@handle</code> patterns in the body string and renders them as inline links. A separate <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>addressees</code> array (the leading recipient pile-up from a fediverse reply) renders as a "Replying to" footer below the body, so the first line of a reply stays content, not a recipient list. The <b>first</b> element of <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>addressees</code> is, by convention, the author of the post being directly replied to — it renders as a filled accent chip with a ↪ glyph. The rest are inherited cc-addressees and render as ghost chips after an <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>· also</code> divider.</p>
            <Grid cols={2}>
              ...
              <Specimen label="Reply · parent only" note="addressees=[parent] · single filled chip · no 'also'" padded={false}>
                <DemoPost
                  body="agreed — this is exactly what I needed to hear today."
                  addressees={['@gridwave']}
                  attachments={[]}/>
              </Specimen>
              <Specimen label="Reply + cc-list" note="addressees=[parent, …cc] · parent filled · cc ghost" padded={false} span={2}>
                <DemoPost
            ...
            <p className="ds-sub" style={{marginBottom: 14}}>When a post is reshared (boosted), the original post is rendered inside a <code style={{fontFamily: 'var(--mono)', fontSize: 11}}>{'<PostBoost/>'}</code> wrapper that adds a 72px attribution rail on the left. The rail has a 4px accent-green edge, a small "boost" tag pill, the repeater's avatar, name, and short relative time. On narrow viewports the rail collapses into a horizontal header row above the post.</p>
            <Grid cols={2}>
              ...
              <Specimen label="Boosted · with photo" note="rail aligns with post regardless of content height" padded={false} span={2}>
                <Post post={{
